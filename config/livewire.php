...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        'disk' => 'local',     // Use local disk for temporary uploads to avoid URL issues
        'rules' => ['required', 'file', 'max:10240', 'mimes:pdf,jpeg,jpg,png,gif'], // 10MB max, specific file types
